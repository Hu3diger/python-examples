...
print('O cliente mais alto é o de codigo %i com %f' %\
    (codigoMaisAlto, maisAlto))
print('O cliente mais baixo é o de codigo %i com %f' %\
    (codigoMaisBaixo, maisBaixo))
print('O cliente mais magro é o de codigo %i com %f' %\
    (codigoMaisMagro, maisMagro))
print('O cliente mais gordo é o de codigo %i com %f' %\
